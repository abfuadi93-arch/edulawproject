...
<section class="bg-[#F4F7F9] py-6 lg:py-8">
        ...
        <div class="mt-5 grid auto-rows-fr gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @forelse ($publications as $publication)
                ...
                <article class="group h-full">
                    <div class="flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-2 shadow-sm transition duration-300 group-hover:-translate-y-0.5 group-hover:shadow-xl group-hover:shadow-brand-ink/10">
                        ...
                        <div class="mt-3 grid grid-cols-[1fr_2.75rem] gap-2">
                            <a
                                ...
                                class="inline-flex min-h-11 items-center justify-center rounded-lg bg-brand-navy px-3 py-2 text-xs font-bold text-white transition hover:bg-brand-black"
                            >
                                Baca Ringkasan
                            </a>
