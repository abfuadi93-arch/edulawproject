...
<section class="relative isolate min-h-[640px] overflow-hidden bg-[#082344] py-3 text-white sm:min-h-[640px] lg:min-h-[640px]" data-home-hero>
    <x-responsive-image
        :src="$heroImage"
        :alt="$heroAlt"
    ...
    <div class="section-shell flex min-h-[640px] items-center pb-24 pt-16 sm:min-h-[640px] lg:min-h-[640px] sm:pb-28 lg:py-20 lg:pb-28">
