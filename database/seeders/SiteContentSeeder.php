...
class SiteContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $settings = [
            ...
            ['group' => 'Identitas', 'key' => 'site.short_description', 'label' => 'Deskripsi Singkat', 'type' => 'textarea', 'value' => 'Platform literasi hukum di ruang digital yang menghadirkan edukasi, riset, program, multimedia, dan kanal pengembangan hukum.', 'sort_order' => 4],
    ...
    {
        $blocks = [
            ['area' => 'home.hero', 'eyebrow' => 'Equal · Educative · Embrace', 'title' => 'Membangun Literasi Hukum yang Mudah Diakses, Relevan, dan Berdampak', 'body' => 'Platform literasi hukum di ruang digital yang menghadirkan edukasi, riset, program, multimedia, dan kanal pengembangan hukum.', 'image' => 'images/hero/hero-edulaw.jpg', 'image_alt' => 'Kegiatan literasi hukum Edulaw Project', 'url' => '/insight', 'url_label' => 'Jelajahi Editorial', 'meta' => ['secondary_url' => '/program', 'secondary_label' => 'Lihat Program'], 'sort_order' => 1],
            ...
            ['area' => 'about.focus', 'title' => 'Editorial', 'body' => 'Esai dan analisis hukum dengan gaya akademik yang tetap terbaca.', 'icon' => 'pen', 'sort_order' => 3],
            ...
            ['area' => 'about.timeline', 'eyebrow' => '2024', 'title' => 'Ekspansi Program', 'body' => 'Diskusi Literasi Konstitusi, editorial, dan kolaborasi publik mulai berkembang.', 'sort_order' => 4],
